...
static double sequential_version_clean(const char *text, const char *pattern, size_t *final_count) {
...
static double parallel_version_clean(const char *text, const char *pattern, size_t K_threads, size_t L_limit, size_t *final_count) {
    struct timespec start, end;
